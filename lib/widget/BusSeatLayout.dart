...
import 'package:pstu_bus_ticket/widget/RightSideSeat.dart';
import 'package:pstu_bus_ticket/widget/SeatStatus.dart';
import 'package:pstu_bus_ticket/widget/Size_picker.dart';
import 'package:pstu_bus_ticket/widget/leftSideSeat.dart';
          ...
          children: [
            ...
            Center(
              child: Row(
                ...
                children: [
                  Text("Via : ", style: TextStyle(fontSize: 20)),
                  Text("Dhaka"),
                  Text(" - "),
                  Text("Chittagong"),
                  Text(" - "),
